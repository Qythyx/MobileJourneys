...
public sealed record SwipeRight(string OnElementId) : JourneyAction(OnElementId)
{
	public override void Execute(TestDriver driver) => driver.SwipeRight(OnElementId);
}
